...
import utilities.Multiple_Environment;

public class Level_23_Multiple_Environment_Java_Owner extends BaseTest {
	...
	String email;
	Multiple_Environment environment;

	@Parameters({ "browser", "environment" })
	@BeforeClass
	public void beforeClass(String browserName, String environmentName) {
		environment = ConfigFactory.create(Multiple_Environment.class); // Tạo ra 1 instance của class Environment, sử dụng
